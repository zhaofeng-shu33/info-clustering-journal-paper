...
There has been little prior work on applying Info-Clustering methods to data engineering problems except for some proof-of-concept experiment \citet{mac}. In this paper, we will consider the application
of our graph-based Info-Clustering.

\section{Formulation of graph-based info-clustering}
