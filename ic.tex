...
clusterpath based on convex optimization \cite{hocking2011clusterpath}, graph partition based on Dasgupta's cost \cite{dasgupta2016cost}, Gradient-based Hierarchical Clustering based on hyperbolic gemetry \cite{hyperbolic} etc.
