...
In Algorithm \ref{alg:psp}, a magic function DT is used to get the miminal value. It is more practical to use
Edmond's greedy method instead of fusion set by \cite{narayanan}.
For general submodular function $f[\mathcal{P}]$ there has been some practical algorithms to optimize it \citep{chakrabarty2014provable} but it is infeasible to apply such kind of algorithms to .
