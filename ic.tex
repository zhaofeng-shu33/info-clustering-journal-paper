...
has some theoretical benefits but suffers from sub-optimization of mutual information cost in the agglomerative approximation. It is until the proposal of multivariate information metric in clustering that there is some breakthrough \citep{ic2016}.
