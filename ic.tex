...
In Algorithm For general submodular function $f[\mathcal{P}]$ there has been some practical algorithms to optimize it \citep{chakrabarty2014provable} but it is infeasible to apply such kind of algorithms to .
