...
Outlier Detection is the identification of abnormal data (called outliers) which differs from the majority of the data (called inliers) \cite{grubbs1969procedures}
To apply our GBIC method to this scanerio, we consider the case when we are required to detect outliers in a multi-class dataset and then we use critical values of $C_{\gamma}(Z_V)$. 
