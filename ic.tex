...
For such method, the metric of mutual information is used and an agglomerative scheme is adopted \cite{mim}. The mutual information between samples and cluster labels is estimated using XXX.
